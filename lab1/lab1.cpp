...
void Lab1::Init()
{
    ...
    // no matter how many times we want to draw this mesh.
    {
        ...
        quadMesh->LoadMesh(PATH_JOIN(window->props.selfDir, RESOURCE_PATH::MODELS, "primitives"), "quad.obj");
        meshes[quadMesh->GetMeshID()] = quadMesh;
    }
...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes[shape], glm::vec3(0, 0.5f, 1), glm::vec3(0.5f));
...
void Lab1::OnInputUpdate(float deltaTime, int mods)
{
    ...
    //BONUS
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT) && window->KeyHold(GLFW_KEY_LEFT_CONTROL) && limp >= 0) {
        ...
        limp -= 0.01;  // the object will move a "limp" distance and then will instantly halt
    }
}
