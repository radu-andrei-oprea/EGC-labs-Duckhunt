...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(5, 0, 0), glm::vec3(0, 2, 0), glm::vec3(1, 2, 1)),    //0
            VertexFormat(glm::vec3(5, 5, 0), glm::vec3(0, 2, 0), glm::vec3(1, 2, 1)),    //1
            VertexFormat(glm::vec3(0, 5, 0), glm::vec3(0, 2, 0), glm::vec3(1, 2, 1)),    //2
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(2, 0, 0), glm::vec3(1, 2, 1)),    //3
            VertexFormat(glm::vec3(5, 0, 5), glm::vec3(2, 0, 0), glm::vec3(1, 2, 1)),    //4
            VertexFormat(glm::vec3(5, 5, 5), glm::vec3(0, 0, 2), glm::vec3(1, 2, 1)),    //5
            VertexFormat(glm::vec3(0, 5, 5), glm::vec3(0, 0, 2), glm::vec3(1, 2, 1)),    //6
            VertexFormat(glm::vec3(0, 0, 5), glm::vec3(0, 0, 2), glm::vec3(1, 2, 1)),    //7
        };
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(4, 0, -3), glm::vec3(0.8, 0.5, 0.5)),        //0
            VertexFormat(glm::vec3(7, 0, -3), glm::vec3(0.8, 0.2, 0.2)),        //1
            VertexFormat(glm::vec3(5.5, 0, -6), glm::vec3(0.8, 0.1, 0.1)),      //2
            VertexFormat(glm::vec3(5.5, 5, -4.5), glm::vec3(0.2, 0.9, 0.9))     //3
        };                                                                      // 0.8, 0.5, 0.5 - pink
        ...
        CreateMesh("tetrahedon", vertices, indices);
    }
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, -5), glm::vec3(0, 1, 0)), //0
            VertexFormat(glm::vec3(0, 2, -5), glm::vec3(1, 1, 0)), //1
            VertexFormat(glm::vec3(2, 0, -5), glm::vec3(1, 1, 0)), //2
            VertexFormat(glm::vec3(2, 2, -5), glm::vec3(1, 0, 0))  //3
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedon"], shaders["VertexColor"], glm::vec3(0.f, 0.f, 0.f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.f, 0.f, 0.f));
